...
class Medmnist_Handler(Dataset):
    def __init__(self, X, Y, transform):
        self.X = X
        self.Y = Y
        self.transform = transform
    ...
    def __getitem__(self, index):
        ...
        #print(type(x))
        #print("this is y",y)
        #print(Image.fromarray(self.X[860]))
...
class Medmnist_Handler_joint(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.transform is not None:
            ...
            x_1 = Image.fromarray(np.uint8(x_1))
            x_1 = self.transform(x_1)

            x_2 = Image.fromarray(np.uint8(x_2))
            x_2 = self.transform(x_2)
