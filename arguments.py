...
def get_args():
	...
	parser.add_argument('--quota', '-q', default=18000, type=int, help='quota of active learning')
	parser.add_argument('--batch', '-b', default=1000, type=int, help='batch size in one active learning iteration')
	parser.add_argument('--dataset_name', '-d', default='CIFAR100', type=str, help='dataset name')
	...
	parser.add_argument('--out_path', type=str, default='./../result', help='Path to where the output log will be')
	...
	parser.add_argument('--initseed', '-s', default = 2000, type = int, help = 'Initial pool of labeled data')
	parser.add_argument('--gpu', '-g', default =0, type = str, help = 'which gpu')
	parser.add_argument('--seed', default=42, type=int, help='random seed')
	parser.add_argument('--ratio',default=0.02,type=float,help='ratio of batch divided by dataset size')
	
	# lpl
	parser.add_argument('--lpl_epoches', type=int, default=200, help='lpl epoch num after detach')
	# ceal
